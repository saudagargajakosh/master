    ...
    <nav class="navbar navbar-default navbar-fixed-top" style="z-index:1112 !important">
      <div class="fluid-container">
        ...
        <div class="navbar-header" style="">
		  ...
		  <a class="navbar-brand" href="<?php echo $url_mapper['index/']; ?>"><?php //echo APPNAME; ?>livelihood</a>
        </div>
		...
		<ul class="nav navbar-nav navbar-<?php echo $lang['direction-right']; ?>" >
			...
			?>
				...
				<li><a href="http://localhost/final_jobportal/?loginto=livelihood"><i class="glyphicon glyphicon-off"></i>&nbsp;&nbsp;<?php echo $lang['index-user-login']; ?></a></li>
			<?php
			} else {
				//global user avatar
		  ...
		  <style type="text/css">
			...
			.input-span { display: inline-block; width: 50%; border: 1px solid #ccc; }
		  </style>
		    <form action="<?php echo $url_mapper['questions/create'] ?>" method="post" role="form" enctype="multipart/form-data" name="search_q">
		    	<div class="row">
		    		<div class="input-group searchbox hidden-sm hidden-xs col-md-6">
		    			<div class="input-span">
		    				<input type="text" name="title" id="search_title" class="searchbox-field typeahead search_sa" placeholder="<?php echo $lang['index-search-title']; ?>">
		    			</div>
		    			<div class="input-span">
		    				<input type="text" name="pin_location" id="search_pin" class="searchbox-field typeahead search_sa" placeholder="<?php echo $lang['index-search-location']; ?>">
		    			</div>
		  ...
		  <!-- <form action="<?php echo $url_mapper['questions/create'] ?>" method="post" role="form" enctype="multipart/form-data">
		  		<div class="row">
					<div class="input-group searchbox hidden-sm hidden-xs col-lg-4 col-md-3" style="">
					...
					<div class="input-group searchbox hidden-sm hidden-xs col-lg-4 col-md-3" style="">
					  <input type="text" name="location" placeholder="Location Pin" class="searchbox-field form-control typeahead">
					  <span class="input-group-btn">
						<button class="btn btn-default" type="submit"><?php echo $lang['index-search-button']; ?>!</button>
					  </span>
					</div>
