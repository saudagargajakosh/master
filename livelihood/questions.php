...
<div class="row">
	...
	<div class="col-md-7">
		...
		<?php
			...
			$indust_id = Question::get_industry_id($uri_segment[6]);
			// echo "<pre>"; print_r($indust_id[0]->cat_id); exit;
			$industry_list = Industriy_list::get_industry_listing($indust_id[0]->cat_id);
			if(count($industry_list) > 0)
			{
				?>
				<p>Related Industry</p>
				<ul>
					<?php 
					foreach ($industry_list as $indust) {
						?>
						<li>
							<?php echo $indust->company_name; ?>
						</li>
						<?php
					}
					?>
	...
	<div class="col-md-2 hidden-sm hidden-xs">
		...
		<hr>
		<ul class="feed-ul">
			<li><a href="<?php echo $url_mapper['pages/view']; ?>about-us" class="col-md-12 hidden"><?php echo $lang['pages-about-title']; ?></a></li>
			<li><a href="<?php echo $url_mapper['pages/view']; ?>contact-us" class="col-md-12 hidden"><?php echo $lang['pages-contact-title']; ?></a></li>
			<li><a href="<?php echo $url_mapper['pages/view']; ?>privacy-policy" class="col-md-12 hidden"><?php echo $lang['pages-privacy-title']; ?></a></li>
			<li><a href="<?php echo $url_mapper['pages/view']; ?>terms" class="col-md-12 hidden"><?php echo $lang['pages-terms-title']; ?></a></li>
