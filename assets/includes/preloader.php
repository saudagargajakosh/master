...
$(".searchbox-field").focusout(function() {
	search_nm = $(this).attr("name");
	$(".overlay").fadeOut(100);
});

var search_nm = ''; 

$(".searchbox-field").keyup(function() {
	search_nm = $(this).attr("name");
	if(search_nm == 'pin_location')
	{
	    var x = document.forms["search_q"]["pin_location"].value;
	    if (isNaN(x)) 
	    {
	    	$(".overlay").css({"display":"none"});
		    alert("Location must be a area pincode of 6 digits.");
		    return false;
	    }
	}
});
