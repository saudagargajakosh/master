        ...
        <!--Job Detail-->      
          ...
          <div class="searchjoblist">
            ...
            <div class="boxwraper">
              <div class="titlebar">
                <div class="row">
                  <div class="col-md-6"><b>Current Certification in <?php echo $row_company->company_name;?></b></div>
                  <div class="col-md-6 text-right"><strong>Certification <?php echo $total_opened_jobs;?></strong> </div>
                </div>
              </div>
