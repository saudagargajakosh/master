        ...
        <div class="candidatesection">          
          <div class="col-md-9">            
            ...
            <div class="form-group">      
       		<input type="text" name="job_params" id="job_params" class="form-control" placeholder="Enter Skill to Search for Certification" value="<?php echo $param;?>" />
...
<div class="container">
  ...
  $col = '10';
	...
	if($result):
		$col = '7';
  		$this->load->view('common/left_certification_search');
	endif;
	endif;
	?>
          ...
          <li>
            <div class="row">
			  ...
			  ?>
                  ...
                  <?php else:?>
                  <a href="<?php echo base_url('certifications/'.$row->job_slug.'?apply=yes');?>" class="btn btn-success">Apply Now</a>
                  <?php endif;?>
