    ...
    <div class="col-md-10">
      ...
      <div class="row"> 
        ...
        <div class="col-md-4">
          ...
          <div class="actionBox">
            <h6><?php echo ($is_already_applied=='yes')?'You have already applied for this voulnteer':'To Apply for this voulnteer click below';?></h6>
            <p></p>
        ...
        <div class="col-md-8"> 
          ...
          <div class="boxwraper">
            <div class="titlebar">
              <div class="row">
                <div class="col-sm-6"><h4>voulnteer Detail</h4></div>
                <?php if($len){?>
                ...
                <div class="col-md-12">
                  ...
                  <div class="skillBox">
                    <ul class="skillDetail">
                     ...
                     <a href="<?php echo base_url();?>search-voulnteers/<?php echo make_slug($skill);?>" target="_blank"><?php echo $skill;?></a></li>
