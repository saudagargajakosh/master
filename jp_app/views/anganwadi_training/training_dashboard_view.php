       ...
       <!-- <div class="col-md-12">
          <div class="userinfoWrp">
            ...
            <div class="col-md-2 uploadPhoto">
            	<img src="<?php echo base_url('public/uploads/anganwadi_training/'.$image_name);?>"  />
                <div class="stripBox">
            <form name="frm_emp_up" id="frm_emp_up" method="post" action="<?php echo base_url('anganwadi_training/edit_anganwadi_training/upload_logo');?>" enctype="multipart/form-data"><input type="file" name="upload_logo" id="upload_logo" accept="image/*" style="display:none;"></form>
            ...
            <div class="col-md-4">
              ...
              <a href="<?php echo base_url('anganwadi_training/edit_company');?>" id="edit_company_profileee" class="editLink"><i class="fa fa-pencil">&nbsp;</i> Edit Company Profile</a> </div>
            <div class="clear"></div>
          </div>
        </div>
        <div class="clear"></div>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="<?php echo base_url('anganwadi_training/training_applications');?>">View All</a></div>
          </div>
        </div>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="<?php echo base_url('anganwadi_training/post_new_training');?>">Post a New Job</a>&nbsp;<a href="<?php echo base_url('anganwadi_training/my_posted_training');?>">View All</a></div>
          </div>
        </div>
            ...
            <div class="intlist">
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  ...
                  <a href="<?php echo base_url('anganwadi_training/edit_posted_anganwadi_training/'.$row_jobs->ID);?>" title="Edit" class="edit-ico"><i class="fa fa-pencil">&nbsp;</i></a>
