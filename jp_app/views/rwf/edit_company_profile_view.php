  ...
  <div class="dashiconwrp">
   ...
   <?php $this->load->view('employer/common/category');?>
    ...
    <div class="formwraper">
        ...
        <div class="row"> <?php echo form_open_multipart('rwf/edit_company',array('name' => 'emp_comp_form', 'id' => 'emp_comp_form', 'onSubmit' => 'return validate_employer_company_form(this);'));?>
          <div class="col-md-9">
            <div class="formint">
