...
<div class="container detailinfo">
  ...
  <?php echo form_open_multipart('rwf_certification/post_new_certification',array('name' => 'post_job_form', 'id' => 'post_job_form', 'onSubmit' => 'return validate_new_post_job_form(this);'));?>
    <div class="col-md-8">
      <div class="formwraper">
        ...
        <div class="formint">
         ...
         <div class="form-group <?php echo (form_error('pay'))?'has-error':'';?>">
            <label class="form-group-addon">Fees( Rs.) <span>*</span></label>
