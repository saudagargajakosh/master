          ...
          <div class="col-md-9">            
            ...
            <div class="form-group">      
              ...
              <span class="form-group-btn">
                 <input type="submit" name="resume_submit" class="btn" id="resume_submit" value="Search Job" style="margin-left: 10px;">
              </span>
            </div> 
            ...
            <div class="col-md-3">            
            <a href="<?php echo base_url('employer/post_new_job');?>" title="jobs" class="btn btn-primary">Post a Job</a>
            <div class="clear"></div>
          </div>
                ...
                <div class="col-md-7">
                  ...
                  <div class="devinfo"><strong>Skills:</strong>
                    <?php 
						...
						if($i<5):
				  ?>
                    <a href="<?php echo base_url('search-resume/'.make_slug($keyword_row->skill_name));?>" class="btn-primary" style="background-color:#c2d4a6;" target="_blank" ><?php echo $keyword_row->skill_name;?></a>
                    <?php endif; endforeach;?>
                  </div>
                  <?php endif;?>
                </div>
				<div class="form-group keyword" class="col-md-5" allign="right" style="padding-left: 34px;">
                 <a href="<?php echo base_url('candidate/'.$encrypt_id);?>" target="_blank" class="btn btn-primary">View Profile</a>
                  <div class="date"></div>
                </div>
                <div class="clear"> </div>
              </div>
