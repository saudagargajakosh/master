...
.ui-autocomplete-input {
	...
	<script>        
           function phoneno(){          
            $('#mobile_phone).keypress(function(e) {
                var a = [];
                var k = e.which;
...
<div class="siteWraper" style="padding:75px;">
<!--Header-->
...
<div class="container detailinfo">
  <div class="row"> <?php echo form_open_multipart('employer_signup',array('name' => 'emp_form', 'id' => 'emp_form', 'onSubmit' => 'return validate_employer_form(this);'));?>
    <div class="col-md-10">
      ...
      <div class="formwraper">
        ...
        <div class="formint">
		  ...
		  <div class="form-group <?php echo (form_error('full_name'))?'has-error':'';?>">
            ...
            <label class="form-group-addon">Contact Number <span>*</span></label>
            <input name="mobile_phone" type="text" class="form-control" id="mobile_phone" value="<?php echo set_value('mobile_phone'); ?>" maxlength="10" />
          ...
          <div class="form-group <?php echo (form_error('pass_code'))?'has-error':'';?>">
      ...
      <!--<div class="formwraper">
        ...
        <div class="formint">
          ...
          <div class="form-group <?php echo (form_error('company_logo'))?'has-error':'';?>">
            <label class="form-group-addon">Company Logo <span>*</span></label>
    ...
    <!--/Job Detail--> 
    <?php echo form_close();?>
    <!--<?php $this->load->view('common/right_ads_employer');?>-->
  </div>
</div>
</div>
