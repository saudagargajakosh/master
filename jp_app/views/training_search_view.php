        ...
        <div class="candidatesection">          
          <div class="col-md-9">            
            ...
            <div class="form-group">      
       		<input type="text" name="job_params" id="job_params" class="form-control" placeholder="Enter Skill to Search for Training" value="<?php echo $param;?>" />
          ...
          <li>
            <div class="row">
			  ...
			  ?>
                  ...
                  <?php else:?>
                  <a href="<?php echo base_url('trainings/'.$row->job_slug.'?apply=yes');?>" class="btn btn-success">Apply Now</a>
                  <?php endif;?>
