            ...
            <div class="intlist">
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  ...
                  <a href="<?php echo base_url()?>industry_yple_certification/edit_posted_industry_yple_certification/<?php echo $row_jobs->ID;?>" title="Edit" class="edit-ico"><i class="fa fa-pencil">&nbsp;</i></a>
