...
<div class="container detailinfo">
  ...
  <?php echo form_open_multipart('industry_yple_certification/edit_posted_industry_yple_certification/'.$id,array('name' => 'post_job_form', 'id' => 'post_job_form', 'onSubmit' => 'return validate_new_post_job_form(this);'));?>
    <div class="col-md-8">
    <?php echo $this->session->flashdata('msg');?>
      <div class="formwraper">
        <div class="titlehead">Edit Posted Certification</div>
        <div class="formint">
          <div class="form-group <?php echo (form_error('industry_id'))?'has-error':'';?>">
            <label class="form-group-addon">Category <span>*</span></label>
          ...
          <div class="form-group <?php echo (form_error('job_title'))?'has-error':'';?>">
            <label class="form-group-addon">Job Title <span>*</span></label>
          ...
          <div class="form-group <?php echo (form_error('vacancies'))?'has-error':'';?>">
            <label class="form-group-addon">No.of Vacancies <span>*</span></label>
          ...
          <div class="form-group <?php echo (form_error('experience'))?'has-error':'';?>">
            <label class="form-group-addon">Experience Required <span>*</span></label>
          ...
          <div class="form-group <?php echo (form_error('job_mode'))?'has-error':'';?>">
            <label class="form-group-addon">Job Mode <span>*</span></label>
          ...
          <div class="form-group <?php echo (form_error('pay'))?'has-error':'';?>">
            <label class="form-group-addon">Salary Offer(Pk Rs.) <span>*</span></label>
          ...
          <div class="form-group <?php echo (form_error('last_date'))?'has-error':'';?>">
            <label class="form-group-addon">Apply Before <span>*</span></label>
          ...
          <div class="form-group <?php echo (form_error('qualification'))?'has-error':'';?>">
            <label class="form-group-addon">Qualification <span>*</span></label>
          ...
          <div class="form-group <?php echo (form_error('job_description'))?'has-error':'';?>">
            <label class="form-group-addon">Job Description</label>
      ...
      <div class="formwraper">
        ...
        <div class="formint">
          ...
          <div class="form-group">
            <label class="form-group-addon">Add Skill<span>*</span></label>
            <div class="row">
              <div class="col-md-8">
              <div class="ui-widget">
      ...
      <div class="formwraper">
        ...
        <div class="formint">
          <div class="form-group <?php echo (form_error('contact_person'))?'has-error':'';?>">
            <label class="form-group-addon">Contact Person <span>*</span></label>
          ...
          <div class="form-group <?php echo (form_error('contact_phone'))?'has-error':'';?>">
            <label class="form-group-addon">Phone <span>*</span></label>
