...
<div class="container detailinfo">
  ...
  <?php echo form_open_multipart('industry_yple_certification/post_new_certification',array('name' => 'post_job_form', 'id' => 'post_job_form', 'onSubmit' => 'return validate_new_post_job_form(this);'));?>
    <div class="col-md-8">
      <div class="formwraper">
        ...
        <div class="formint">
          ...
          <div class="form-group <?php echo (form_error('job_title'))?'has-error':'';?>">
            <label class="form-group-addon">Certification Title <span>*</span></label>
      ...
      <div class="formwraper">
        ...
        <div class="formint">
          ...
          <div align="center" class="footeraction">
            ...
            <input type="submit" name="submit_button" id="submit_button" value="Post Certification" class="btn btn-success" />
          </div>
        </div>
      </div>
