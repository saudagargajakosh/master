      ...
      <div class="row"> 
        ...
        <div class="col-md-8"> 
          ...
          <div class="boxwraper">
            <div class="titlebar">
              <div class="row">
                <div class="col-sm-6"><h4>Certificcation Detail</h4></div>
                <?php if($len){?>
            ...
            <div class="row"> 
              ...
              <div class="col-md-12">
                <ul class="reqlist">
                    ...
                    <div class="col-sm-6">Certification price:</div>
            ...
            <div class="jobdescription">
                ...
                <div class="col-md-12">
                  ...
                  <div class="skillBox">
                    <ul class="skillDetail">
                     ...
                     <a href="<?php echo base_url();?>search-certification/<?php echo make_slug($skill);?>" target="_blank"><?php echo $skill;?></a></li>
              ...
              <div class="actionBox footeraction">
                <h6><?php echo ($is_already_applied=='yes')?'You have already applied for this certification':'To Apply for this certification click below';?></h6>
              ...
              <div class="footeraction">
                <p><strong>Note:</strong>Wright something</p>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            <label class="input-addon">Please enter: <span id="ccode"><?php echo $cpt_code;?></span> in the text box below:</label>
