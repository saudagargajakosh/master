          ...
          <li>
            <div class="row">
			  ...
			  ?>
                  ...
                  <?php else:?>
                  <a href="<?php echo base_url('jobs/'.$row->job_slug.'?apply=yes');?>" class="btn btn-success">Apply Now</a>
                  <?php endif;?>
             ...
             <p><?php echo word_limiter(strip_tags(str_replace('-',' ',$row->job_description)),30);?></p>
          </li>
          <?php 
				  			endforeach;
							else: ?>
