...
<!--Header-->
<?php $this->load->view('common/header_shg'); 
      ...
      <div class="row"> 
        ...
        <div class="col-md-4">
          <div class="companyinfoWrp">
			...
			?>
            <h6 class="jobname"><?php echo humanize($job_title);?></h6>
          ...
          <div class="actionBox">
            <h6><?php echo ($is_already_applied=='yes')?'You have already applied for this Training':'To Apply for this training click below';?></h6>
            <p></p>
            <a href="javascript:;" class="<?php echo ($is_already_applied=='yes')?'applyjobgray':'applyjob';?>"><span class="btn btn-success">Apply Now</span></a> <!--<a href="#" class="refferbtn"><span>Email to Friend</span></a>--> </div>
          <div class="mapbox" style="padding:20px;">
        ...
        <div class="col-md-8"> 
          ...
          <div class="boxwraper">
            <div class="titlebar">
              <div class="row">
                <div class="col-sm-6"><h4>Training Detail</h4></div>
                <?php if($len){?>
                <div class="col-sm-6 text-right"><a href="javascript:;" onClick="window.history.back(-1);" class="btn btn-success">Back to Search</a></div>
                <?php }?>
              </div>
            </div>
            ...
            <div class="row"> 
              ...
              <div class="col-md-12">
                <ul class="reqlist">
                    ...
                    <div class="col-sm-6">Training Type:</div>
                    ...
                    <div class="col-sm-6">Training Location:</div>
            ...
            <div class="jobdescription">
                ...
                <div class="col-md-12">
                  ...
                  <div class="skillBox">
                    <ul class="skillDetail">
                      ...
                      <a href="<?php echo base_url();?>search-trainings/<?php echo make_slug($skill);?>" target="_blank"><?php echo $skill;?></a>
              ...
              <div class="actionBox footeraction">
                ...
                <a href="javascript:;" class="<?php echo ($is_already_applied=='yes')?'applyjobgray':'applyjob';?>"><span class="btn btn-success">Apply Now</span></a> </div>
              <div class="clear">&nbsp;</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            <label class="form-group-addon">Please enter: <span id="ccode"><?php echo $cpt_code;?></span> in the text box below:</label>
