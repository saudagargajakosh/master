        ...
        <!--Job Detail-->      
          ...
          <div class="searchjoblist">
            ...
            <div class="boxwraper">
              <div class="titlebar">
                <div class="row">
                  <div class="col-md-6"><b>Current Training in <?php echo $row_company->company_name;?></b></div>
                  <div class="col-md-6 text-right"><strong>Training <?php echo $total_opened_jobs;?></strong> </div>
                </div>
              </div>
              <div class="row searchlist"> 
                ...
                <?php 
                    ...
                    ?>
                <div align="center" class="text-red">No Training opened.</div>
                <?php endif;?>
              </div>
            </div>
          </div>
