...
<div class="row"> <?php echo form_open_multipart('jobseeker_signup',array('name' => 'seeker_form', 'id' => 'seeker_form', 'onSubmit' => 'return validate_form(this);'));?>
  <div class="col-md-10">
    ...
    <div class="formwraper">
      ...
      <div class="formint">
        <div class="form-group <?php echo (form_error('full_name'))?'has-error':'';?>">
          <label class="form-group-addon">Full Name <span>*</span></label>
        ...
        <div class="form-group <?php echo (form_error('gender'))?'has-error':'';?>">
          <label class="form-group-addon">Gender <span>*</span></label>
        ...
        <div class="form-group <?php echo (form_error('dob_day'))?'has-error':'';?>">
          <label class="form-group-addon">Date of Birth <span>*</span></label>
        ...
        <div class="form-group <?php echo (form_error('current_address'))?'has-error':'';?>">
          <label class="form-group-addon">Current Address <span>*</span></label>
        ...
        <div class="form-group <?php echo (form_error('nationality'))?'has-error':'';?>">
          <label class="form-group-addon" name="nationality" id="nationality">Nationality <span>*</span></label>
        ...
        <div class="form-group">
          <label class="form-group-addon">Home Phone</label>
    ...
    <div class="formwraper">
      ...
      <div class="formint">
        <div class="form-group <?php echo (form_error('cv_file') || $msg)?'has-error':'';?>">
          <label class="form-group-addon">Upload Resume <span>*</span></label>
        ...
        <div class="formsparator">
          <div class="form-group">
            <label class="form-group-addon">Please enter: <?php echo $cpt_code;?> in the text box below:</label>
            <div class="form-group <?php echo (form_error('captcha'))?'has-error':'';?>">
              <label class="form-group-addon"></label>
