      ...
      <div class="formwraper">
        ...
        <div class="formint">
         <div class="form-group <?php echo (form_error('description'))?'has-error':'';?>">
            <label class="form-group-addon">Career Objective <span>*</span></label>
          ...
          <div class="form-group <?php echo (form_error('awards'))?'has-error':'';?>">
            <label class="form-group-addon">Achievements <span>*</span></label>
