            ...
            <div class="user-intro">
              ...
              <div class="candidate-info">
                ...
                <div class="rating-star">
                  <span ><form name="frm_js_up" id="frm_js_up" method="post" action="<?php echo base_url('jobseeker/edit_jobseeker/upload_photo');?>" enctype="multipart/form-data"><input type="file" name="upload_pic" id="upload_pic" accept="image/*" style="display:none;"></form></span>
                  <span ><a href="javascript:;" class="upload" title="Upload Photo"><i class="fa fa-upload"></i></a>
            <?php if($row->photo!=''):?>
          ...
          <div class="col-md-8 col-sm-12">
            ...
            <div class="primary-info">
              ...
              <div class="row">
                ...
                <div class="col-sm-4">
                  <i class="fa fa-calendar-o"></i> <?php echo $row->dob;?>
                </div>
