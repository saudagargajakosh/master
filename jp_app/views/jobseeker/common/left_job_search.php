...
<div class="secondary">
    <!--Widget-->
    <div class="widget">
      <h4 class="widget-title">Certification Title</h4>
    ...
    <div class="widget">
      ...
      <?php foreach($left_side_city as $row_city):?>
        <li> <a href="<?php echo base_url('search-certification'.str_replace(' ','-',trim($param)).'/'.make_friendly_url($row_city->city));?>"><span class="badge pull-right"><?php echo $row_city->score;?></span><?php echo character_limiter($row_city->city, 14);?></a> </li>
      <?php endforeach;?>
      </ul>
    </div>
