      ...
      <div class="formwraper">
        ...
        <div class="formint">
          ...
          <div class="form-group <?php echo (form_error('title'))?'has-error':'';?>">
            <label class="form-group-addon">Title <span>*</span></label>
          ...
          <div class="form-group <?php echo (form_error('story'))?'has-error':'';?>">
            <label class="form-group-addon">Story <span>*</span></label>
