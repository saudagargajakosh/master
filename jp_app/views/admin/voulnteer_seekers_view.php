...
<aside class="right-side"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Manage Voulnteer</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body table-responsive">
            <form name="search_form" id="search_form" method="post" action="<?php echo base_url('admin/voulnteer_seekers/search');?>">
              <div class="row" style="background-color:#3C8DBC; padding:10px; margin:0;">
                ...
                <div class="col-md-4 margin-bottom-special">
                  ...
                  &nbsp;&nbsp;
                  <input class="btn" name="button" value="View All" type="button" onClick="document.location='<?php echo base_url('admin/voulnteer_seekers');?>';">
                </div>
              </div>
            </form>
            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td align="center"><a href="<?php echo base_url('admin/voulnteer_seekers/details/'.$row->ID);?>">
