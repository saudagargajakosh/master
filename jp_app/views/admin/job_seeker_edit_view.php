        ...
        <div class="box box-primary">
          ...
          <form name="frm_job_seeker" id="frm_job_seeker" role="form" method="post" action="<?php echo base_url('admin/job_seekers/update/'.$row->ID);?>">
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="exampleInputPassword1">Mobile Number</label><?php  $key=$row->mobile;
				?>
				

                <input type="text" class="form-control" name="mobile" id="mobile" value="<?php echo $this->encrypt->decode($key);?>"  >
