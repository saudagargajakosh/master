...
<aside class="right-side"> 
  ...
  <section class="content-header">
    <h1> Employers Management ->Certification
      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body table-responsive">
            <?php $this->load->view('admin/common/certification_quick_search_bar'); ?>
              ...
              <tbody>
				...
				if($result):
					foreach($result as $row):
						$json_row = array();
						$total_posted_jobs = $this->posted_certification_model->count_records('pp_post_certification','employer_id',$row->ID);
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td valign="middle"><a class="btn btn-primary btn-xs" href="<?php echo base_url('admin/posted_certifications/certification_by_company/'.$row->ID);?>" target="_blank">View (<?php echo $total_posted_jobs;?>)</a></td>
                  ...
                  <td valign="middle"><a href="javascript:;" class="btn btn-primary btn-xs" onClick="load_quick_profile_view('<?php echo $json_string;?>', '<?php echo $total_posted_jobs;?>');">Profile View</a> <a href="javascript:;" onClick="load_quick_job_view('<?php echo $row->ID;?>', '<?php echo $row->company_name;?>');" class="btn btn-primary btn-xs">Certification View</a>
