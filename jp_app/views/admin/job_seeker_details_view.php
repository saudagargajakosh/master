                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td align="center"><?php
				  		if($row->is_featured=='yes')
							...
							$class_label = 'warning';
				  ?>
                    <a onClick="update_featured_job(<?php echo $row->job_ID;?>);" href="javascript:;" id="f_<?php echo $row->job_ID;?>"> <span class="label label-<?php echo $class_label;?>"><?php echo camelize($row->is_featured);?></span> </a></td>
                  <td><?php
				  		if($row->sts=='active')
							$class_label = 'success';
						elseif($row->sts=='closed')
							...
							$class_label = 'warning';
				  ?>
                    <a onClick="update_posted_job_status(<?php echo $row->job_ID;?>);" href="javascript:;" id="sts_<?php echo $row->job_ID;?>"> <span class="label label-<?php echo $class_label;?>"><?php echo camelize($row->sts);?></span> </a></td>
                </tr>
                <?php endforeach; else:?>
                <tr>
