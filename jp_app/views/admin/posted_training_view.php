      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">All Posted Training</h3>
            <!--Pagination-->
          ...
          <div class="box-body table-responsive">
            <form name="search_form" id="search_form" method="post" action="<?php echo base_url('admin/posted_trainings/search');?>">
              <div class="row" style="background-color:#3C8DBC; padding:10px; margin:0;">
                ...
                <div class="col-md-2 margin-bottom-special" style="padding:0;">
                  ...
                  &nbsp;&nbsp;
                  <input class="btn" name="button" value="View All" type="button" onClick="document.location='<?php echo base_url('admin/posted_trainings');?>';">
                </div>
              </div>
            </form>
