...
<form name="search_form" id="search_form" method="get" action="<?php echo base_url('admin/employers_industry_yple/search');?>">
  <div class="row" style="background-color:#3C8DBC; padding:10px; margin:0;">
    ...
    <div class="col-md-2 margin-bottom-special">
      ...
      &nbsp;&nbsp;
      <input class="btn" name="button" value="View All" type="button" onClick="document.location='<?php echo base_url('admin/employers_sme');?>';">
    </div>
  </div>
</form>
