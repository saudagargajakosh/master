                            ...
                            <div class="box box-info">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="form-group-addon">.00</span>
                                    </div>
                                    <br/>
                                    <div class="form-group">
                                        <span class="form-group-addon">$</span>
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control">
                                        <span class="form-group-addon"><i class="fa fa-check"></i></span>
                                    </div>
                                    <br/>
                                    <div class="form-group">
                                        <span class="form-group-addon"><i class="fa fa-dollar"></i></span>
                                        <input type="text" class="form-control">
                                        <span class="form-group-addon"><i class="fa fa-ambulance"></i></span>
                                    </div>
                                    ...
                                    <h4>With buttons</h4>
                                    <p class="margin">Large: <code>.form-group.form-group-lg</code></p>
                                    ...
                                    <p class="margin">Small <code>.form-group.form-group-sm</code></p>
