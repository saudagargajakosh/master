...
<aside class="right-side"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url('admin/posted_certification');?>">Posted Certification</a></li>
  ...
  <section class="content invoice"> 
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header"> 
          <!--<i class="fa fa-globe"></i>--> Certification Requirements<small class="pull-right">Job Posted Date <?php echo date_formats($row->dated, 'd/m/Y');?></small> </h2>
      </div>
      <!-- /.col --> 
    </div>
    <!-- info row -->
    <div class="row invoice-info">
      <div class="col-sm-7 invoice-col">
      	<b>Certification Title:</b> <?php echo $row->job_title;?><br/>
      	<b>Certification Category:</b> <?php echo $row->industry_name;?><br/>
   ...
   <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">Certification Description &amp;  Details</h2>
      </div>
      <!-- /.col --> 
    </div>
    <div class="row">
