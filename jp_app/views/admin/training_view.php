      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body table-responsive">
            <?php $this->load->view('admin/common/training_quick_search_bar'); ?>
            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td valign="middle"><a class="btn btn-primary btn-xs" href="<?php echo base_url('admin/posted_trainings/training_by_company/'.$row->ID);?>" target="_blank">View (<?php echo $total_posted_jobs;?>)</a></td>
