...
<aside class="right-side"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url('admin/posted_jobs');?>">Posted Training</a></li>
  ...
  <section class="content invoice"> 
    ...
    <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header"> 
          <!--<i class="fa fa-globe"></i>--> Training Requirements<small class="pull-right">Training Posted Date <?php echo date_formats($row->dated, 'd/m/Y');?></small> </h2>
      </div>
      <!-- /.col --> 
    </div>
    <!-- info row -->
    <div class="row invoice-info">
      <div class="col-sm-7 invoice-col">
      	<b>Training Title:</b> <?php echo $row->job_title;?><br/>
      	<b>Training Category:</b> <?php echo $row->industry_name;?><br/>
   ...
   <div class="row">
      <div class="col-xs-12">
        <h2 class="page-header">Training Description &amp;  Details</h2>
      </div>
      <!-- /.col --> 
    </div>
    <div class="row">
