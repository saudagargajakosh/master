...
<aside class="right-side"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Manage Training Application</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title"><span id="seeker_name"></span>'s Training Applications</h3><div class="paginationWrap"> <?php echo ($result)?$links:'';?> </div>
          </div>
            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td><a href="<?php echo base_url('admin/posted_trainings/details/'.$row->posted_job_id);?>"> <?php echo ellipsize($row->job_title,36,.8);?></td>
                  ...
                  <td align="center"><?php
				  		if($row->is_featured=='yes')
							...
							$class_label = 'warning';
				  ?>
                    <a onClick="update_featured_training(<?php echo $row->job_ID;?>);" href="javascript:;" id="f_<?php echo $row->job_ID;?>"> <span class="label label-<?php echo $class_label;?>"><?php echo camelize($row->is_featured);?></span> </a></td>
                  <td><?php
				  		if($row->sts=='active')
							$class_label = 'success';
						elseif($row->sts=='closed')
							...
							$class_label = 'warning';
				  ?>
                    <a onClick="update_posted_training_status(<?php echo $row->job_ID;?>);" href="javascript:;" id="sts_<?php echo $row->job_ID;?>"> <span class="label label-<?php echo $class_label;?>"><?php echo camelize($row->sts);?></span> </a></td>
                </tr>
                <?php endforeach; else:?>
                <tr>
