      ...
      <div class="col-xs-12">
        <div class="box">
              ...
              <div class="form-body">
                <div class="row">
                  ...
                  <div class="col-md-11 form-group">
                      <label>Upload employer data in xls <a href="<?=base_url('public/excel/sample/employer_rwf.xls')?>" target="_blank" download><font color="red">Export sample excel sheet</font></a></label>
          ...
          <div class="box-body table-responsive">
            <?php $this->load->view('admin/common/employer_rwf_quick_search_bar'); ?>
            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td valign="middle"><a href="<?php echo base_url('admin/employers_rwf/details/'.$row->ID);?>"><?php echo $row->first_name.' '.$row->last_name;?></a></td>
				  ...
				  <td align="center" valign="middle"><a href="<?php echo base_url('admin/employers_rwf/details/'.$row->ID);?>" target="_blank">
                  ...
                  <td valign="middle"><a href="<?php echo base_url('admin/employers_rwf/update/'.$row->ID);?>" class="btn btn-primary btn-xs">Edit Employer</a><br /><a target="_blank" href="<?php echo base_url('admin/employers_rwf/login/'.$row->ID);?>" class="btn btn-primary btn-xs" style="margin:1px;">Login as Employer</a><br /><a href="javascript:delete_employer(<?php echo camelize($row->ID);?>);" class="btn btn-danger btn-xs">Delete Employer</a></td>
                </tr>
                <?php endif; ?>
                <?php endforeach; else:?>
                <tr>
