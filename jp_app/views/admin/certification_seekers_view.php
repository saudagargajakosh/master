...
<aside class="right-side"> 
  ...
  <section class="content-header">
    <h1> certification seeker Management 
      <!--<small>advanced tables</small>--> 
    </h1>
    <ol class="breadcrumb">
      <li><a href="<?php echo base_url('admin/dashboard');?>"><i class="fa fa-dashboard"></i> Home</a></li>
      <!--<li><a href="#">Examples</a></li>-->
      <li class="active">Manage certification seekers</li>
    </ol>
  </section>
      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">All certification seekers</h3>
            <!--Pagination-->
          ...
          <div class="box-body table-responsive">
            <form name="search_form" id="search_form" method="post" action="<?php echo base_url('admin/certification_seekers/search');?>">
              <div class="row" style="background-color:#3C8DBC; padding:10px; margin:0;">
                ...
                <div class="col-md-4 margin-bottom-special">
                  ...
                  &nbsp;&nbsp;
                  <input class="btn" name="button" value="View All" type="button" onClick="document.location='<?php echo base_url('admin/certification_seekers');?>';">
                </div>
              </div>
            </form>
            ...
            <table id="example2" class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <?php echo ($row->ip_address)?'<a href="localhost/'.$row->ip_address.'" target="_blank">'.$row->ip_address.'</a>':'';?>
                  </td>
                  <td align="center"><a href="<?php echo base_url('admin/certification_seekers/details/'.$row->ID);?>">
