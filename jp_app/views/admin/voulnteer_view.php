...
<aside class="right-side"> 
  ...
  <section class="content-header">
    <h1> Employers Management ->voulnteers
      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body table-responsive">
            <?php $this->load->view('admin/common/voulnteer_quick_search_bar'); ?>
              ...
              <tbody>
				...
				if($result):
					foreach($result as $row):
						$json_row = array();
						$total_posted_jobs = $this->posted_voulnteer_model->count_records('pp_post_voulnteer','employer_id',$row->ID);
                ...
                <tr id="row_<?php echo $row->ID;?>">
                  ...
                  <td valign="middle"><a class="btn btn-primary btn-xs" href="<?php echo base_url('admin/posted_voulnteers/voulnteer_by_company/'.$row->ID);?>" target="_blank">View (<?php echo $total_posted_jobs;?>)</a></td>
