   ...
   <?php $this->load->view('employer/common/category');?>
    <div class="col-md-8"> <?php echo $this->session->flashdata('msg');?> 
      ...
      <div class="formwraper">
        ...
        <div class="row"> <?php echo form_open_multipart('anganwadi/edit_company',array('name' => 'emp_comp_form', 'id' => 'emp_comp_form', 'onSubmit' => 'return validate_employer_company_form(this);'));?>
          <div class="col-md-9">
            <div class="formint">
            ...
            <div class="picinner">
              ...
              <div class="stripBox ">
               <form name="frm_emp_up" id="frm_emp_up" method="post" action="<?php echo base_url('anganwadi/edit_employer/upload_logo');?>" enctype="multipart/form-data"><input type="file" name="upload_logo" id="upload_logo" accept="image/*" style="display:none;"></form>
                ...
                <a href="javascript:;" onClick="document.location='<?php echo base_url('anganwadi/edit_employer/delete_company_logo');?>'" class="remove" title="Delete Logo"><i class="fa fa-trash-o"></i></a>
                <?php endif;?>
              </div>
            </div>
          </div>
