...
<div class="secondary">
    <!--Widget-->
    <div class="widget">
      <h6 class="widget-title"> Related Job Title</h6>
    ...
    <div class="widget">
      ...
      <?php foreach($left_side_city as $row_city):?>
        <li> <a href="<?php echo base_url('search-jobs/'.str_replace(' ','-',trim($param)).'/'.make_friendly_url($row_city->city));?>"><span class="badge pull-right"><?php echo $row_city->score;?></span><?php echo strtoupper(character_limiter($row_city->city, 14));?></a> </li>
      <?php endforeach;?>
      </ul>
    </div>
    ...
    <!--Widget-->
    <div class="widget">
      <h6 class="widget-title"> Salary Range </h6>
      <ul class="nav nav-pills nav-stacked">     
