...
class Employers_Anagwadi extends CI_Controller {
	public function index(){
		...
		$config = pagination_configuration(base_url("admin/employers_anagwadi"), $total_rows, 100, 3, 5, true);
		// print_r($config);
	...
	public function details($id=''){
		...
		if($id==''){
			redirect(base_url().'admin/employers_anagwadi','');
			exit;
		}
	...
	public function update($id=''){
		...
		redirect(base_url('admin/employers_anagwadi/update/'.$id));
		return;
	}
	...
	public function search(){
		...
		$config = pagination_configuration_search(base_url("admin/employers_anagwadi/search/?".$url_params), $total_rows, 50, 3, 5, true);
	...
	public function login($id){
			...
			redirect(base_url('jfa/dashboard'));
	}
}