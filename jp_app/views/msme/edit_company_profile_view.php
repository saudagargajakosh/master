   ...
   <?php $this->load->view('employer/common/category');?>
    <div class="col-md-8"> <?php echo $this->session->flashdata('msg');?> 
      ...
      <div class="formwraper">
        ...
        <div class="row"> <?php echo form_open_multipart('msme/edit_company',array('name' => 'emp_comp_form', 'id' => 'emp_comp_form', 'onSubmit' => 'return validate_employer_company_form(this);'));?>
          <div class="col-md-9">
            <div class="formint">
