      ...
      <div class="formwraper">
        ...
        <div class="formint">
          ...
          <div class="form-group <?php echo (form_error('mobile_phone'))?'has-error':'';?>">
            ...
            <input name="mobile_phone" type="text" class="form-control" id="mobile_phone" placeholder="Mobile number" value="<?php echo $row->mobile_phone; ?>" maxlength="15" />
            <?php echo form_error('mobile_phone'); ?> </div>
          <div class="form-group">
            <label class="form-group-addon">Home Phone</label>
            <input name="home_phone" type="text" class="custom-control" id="home_phone" placeholder="Home Phone" value="<?php echo $row->home_phone; ?>" maxlength="15">
          </div>
          <div align="center">
