      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="<?php echo base_url('training/post_new_training');?>">Post a New Job</a>&nbsp;<a href="<?php echo base_url('training/my_posted_training');?>">View All</a></div>
          </div>
        </div>
