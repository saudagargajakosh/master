...
<div class="container detailinfo">
  ...
  <?php echo form_open_multipart('training/post_new_training',array('name' => 'post_job_form', 'id' => 'post_job_form', 'onSubmit' => 'return validate_new_post_job_form(this);'));?>
    <div class="col-md-8">
      <div class="formwraper">
        ...
        <div class="formint">
          ...
          <div class="form-group <?php echo (form_error('job_title'))?'has-error':'';?>">
            <label class="form-group-addon">Training Title <span>*</span></label>
            <input name="job_title" type="text" class="form-control" id="job_title" placeholder="Training Title" value="<?php echo set_value('job_title'); ?>" maxlength="150">
            <?php echo form_error('job_title'); ?> </div>
          <div class="form-group <?php echo (form_error('vacancies'))?'has-error':'';?>">
            <label class="form-group-addon">No.of Course <span>*</span></label>
          ...
          <div class="form-group <?php echo (form_error('job_mode'))?'has-error':'';?>">
            <label class="form-group-addon">Certification Mode <span>*</span></label>
        ...
        <!-- <div class="form-group <?php echo (form_error('pay'))?'has-error':'';?>">
          ...
          <div class="form-group <?php echo (form_error('job_description'))?'has-error':'';?>">
            <label class="form-group-addon">Certification Description</label>
      ...
      <!--Required Skills-->
      <div class="formwraper">
        <div class="titlehead">Please choose the set of skills (Training) you are looking to hire.</div>
        <div class="formint">
          ...
          <div align="center" class="footeraction">
            ...
            <input type="submit" name="submit_button" id="submit_button" value="Post Training" class="btn btn-success" />
          </div>
        </div>
      </div>
