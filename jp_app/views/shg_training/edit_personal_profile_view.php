...
<div class="container detailinfo">
  ...
  <div class="dashiconwrp">
    <?php $this->load->view('certification/common/voulnteer_menu');?>
  </div>
  </div>
  <?php $this->load->view('employer/common/category');?>
  
  <?php echo form_open_multipart('shg_training/edit_personal_profile',array('name' => 'emp_personal_form', 'id' => 'emp_personal_form', 'onSubmit' => 'return validate_employer_personal_form(this);'));?>
    <div class="col-md-9"> 
