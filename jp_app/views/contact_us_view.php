      ...
      <div class="formwraper">
        ...
        <div class="formint">
          ...
          <div class="form-group <?php echo (form_error('email') || $msg)?'has-error':'';?>">
            <label class="form-group-addon">Your Email Address <span>*</span></label>
            <input type="text" class="form-control" name="email" id="email" value="<?php echo set_value('email'); ?>" />
            <?php echo form_error('email'); ?>
          </div>
          
          <div class="form-group <?php echo (form_error('phone') || $msg)?'has-error':'';?>">
            <label class="form-group-addon">Your Phone Number <span>*</span></label>
            <input type="text" class="form-control" name="phone" id="phone" value="<?php echo set_value('phone'); ?>" />
            <?php echo form_error('phone'); ?>
          </div>
          
          <div class="form-group <?php echo (form_error('phone') || $msg)?'has-error':'';?>">
            <label class="form-group-addon">City </label>
            <input type="text" class="form-control" name="city" id="city" value="<?php echo set_value('city'); ?>" />
            <?php echo form_error('city'); ?>
          </div>
          
          <div class="form-group <?php echo (form_error('message') || $msg)?'has-error':'';?>">
            <label class="form-group-addon">Message / Question<span>*</span></label>
