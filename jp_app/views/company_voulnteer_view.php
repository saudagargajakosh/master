...
<!--/Header--> 
<!--Detail Info-->
<div class="container detailinfo" style=" margin-bottom: 44px;">
  
      <div class="row"> 
        <div class="col-md-4 col-sm-6">
        
        <!--Company Info-->       
          <div class="companyinfoWrp" style="padding: 50px;">            
        ...
        <div class="actionBox">
          ...
          <a href="<?php echo base_url('jobseeker_signup_main');?>"  class="btn btn-warning"><span>Register</span></a> <a href="<?php echo base_url('login');?>" class="btn btn-success"><span>Login</span></a> </div>
        <?php endif;?>        
        </div>
        
        
        <div class="col-md-8 col-sm-6" style="padding-bottom:40px;">        
        <!--Job Detail-->      
          ...
          <div class="searchjoblist">
            ...
            <div class="boxwraper">
              <div class="titlebar">
                <div class="row">
                  <div class="col-md-6"><b>Current Voulnteer in <?php echo $row_company->company_name;?></b></div>
                  <div class="col-md-6 text-right"><strong>Voulnteer <?php echo $total_opened_jobs;?></strong> </div>
                </div>
              </div>
              <div class="row searchlist"> 
                ...
                <div class="col-md-12">
                  ...
                  ?>
                        ...
                        <?php else:?>
                        <a href="<?php echo base_url('jobs/'.$row_jobs->job_slug.'?apply=yes');?>" class="btn btn-success">Apply Now</a>
                        <?php endif;?>
                ...
                <?php 
                    ...
                    ?>
                <div align="center" class="text-red">No Voulnteer opened.</div>
                <?php endif;?>
              </div>
            </div>
          </div>
