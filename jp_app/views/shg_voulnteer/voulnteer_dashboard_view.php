      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="<?php echo base_url('shg_voulnteer/voulnteer_applications');?>">View All</a></div>
          </div>
        </div>
        ...
        <div class="experiance">
		  ...
		  ?>
              ...
              <div class="col-md-4"><a href="<?php echo base_url('shg_voulnteer/'.$row_applied_job->job_slug);?>"><?php echo $row_applied_job->job_title;?></a></div>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="<?php echo base_url('shg_voulnteer/post_new_voulnteer');?>">Post a New Voulnteer</a>&nbsp;<a href="<?php echo base_url('shg_voulnteer/my_posted_voulnteer');?>">View All</a></div>
          </div>
        </div>
            ...
            <div class="intlist">
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  ...
                  <a href="<?php echo base_url('shg_voulnteer/edit_posted_voulnteer/'.$row_jobs->ID);?>" title="Edit" class="edit-ico"><i class="fa fa-pencil">&nbsp;</i></a>
