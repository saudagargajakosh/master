...
<div class="container detailinfo">
  ...
  <?php echo form_open_multipart('industry_yple_voulnteer/post_new_voulnteer',array('name' => 'post_job_form', 'id' => 'post_job_form', 'onSubmit' => 'return validate_new_post_job_form(this);'));?>
    <div class="col-md-8">
      <div class="formwraper">
        ...
        <div class="formint">
          ...
          <div class="form-group <?php echo (form_error('job_title'))?'has-error':'';?>">
            <label class="form-group-addon">Voulnteer Title <span>*</span></label>
          ...
          <div class="form-group <?php echo (form_error('vacancies'))?'has-error':'';?>">
            <label class="form-group-addon">No.of voulnteer <span>*</span></label>
          ...
          <div class="form-group <?php echo (form_error('job_mode'))?'has-error':'';?>">
            <label class="form-group-addon">Voulnteer Mode <span>*</span></label>
         ...
         <div class="form-group <?php echo (form_error('pay'))?'has-error':'';?>">
          ...
          <div class="form-group <?php echo (form_error('job_description'))?'has-error':'';?>">
            <label class="form-group-addon">voulnteer Description</label>
      ...
      <div class="formwraper">
        ...
        <div class="formint">
          ...
          <div align="center" class="footeraction">
            ...
            <input type="submit" name="submit_button" id="submit_button" value="Post Voulnteer" class="btn btn-success" />
          </div>
        </div>
      </div>
