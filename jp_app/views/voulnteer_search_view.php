...
<title><?php echo $title;?>Volunteer</title>
        ...
        <div class="candidatesection">          
          <div class="col-md-9">            
            ...
            <div class="form-group">      
       		<input type="text" name="job_params" id="job_params" class="form-control" placeholder="Enter Skill to Search for Volunteer" value="<?php echo $param;?>" />
              <span class="form-group-btn">
                 <input type="submit" name="job_submit" class="btn" id="job_submit" value="Find" style=" margin-left: 10px">
              </span>
            </div>            
...
<div class="container">
  ...
  $col = '10';
	...
	if($result):
		$col = '7';
  		$this->load->view('common/left_voulnteer_search');
	endif;
	endif;
	?>
          ...
          <li>
            <div class="row">
			  ...
			  ?>
                  ...
                  <?php else:?>
                  <a href="<?php echo base_url('voulnteers/'.$row->job_slug.'?apply=yes');?>" class="btn btn-success">Apply Now</a>
                  <?php endif;?>
