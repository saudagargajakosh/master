        ...
        <!--Company Info-->
          ...
          <div class="userinfoWrp">
            ...
            <div class="col-md-2 uploadPhoto">
                ...
                <div class="stripBox">
            <form name="frm_emp_up" id="frm_emp_up" method="post" action="<?php echo base_url('nsdc_vtp/edit_employer/upload_logo');?>" enctype="multipart/form-data"><input type="file" name="upload_logo" id="upload_logo" accept="image/*" style="display:none;"></form>
            ...
            <div class="col-md-6">
              ...
              <a href="<?php echo base_url('nsdc_vtp/edit_company');?>" id="edit_company_profileee" class="editLink"><i class="fa fa-pencil">&nbsp;</i> Edit Company Profile</a> </div>
            <div class="clear"></div>
          </div>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="<?php echo base_url('nsdc_vtp/job_applications');?>">View All</a></div>
          </div>
        </div>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="<?php echo base_url('nsdc_vtp/post_new_job');?>">Post a New Job</a>&nbsp;<a href="<?php echo base_url('employer/my_posted_jobs');?>">View All</a></div>
          </div>
        </div>
            ...
            <div class="intlist">
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  ...
                  <a href="<?php echo base_url('nsdc_vtp/edit_posted_job/'.$row_jobs->ID);?>" title="Edit" class="edit-ico"><i class="fa fa-pencil">&nbsp;</i></a>
