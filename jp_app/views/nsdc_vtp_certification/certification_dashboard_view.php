      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="<?php echo base_url('nsdc_vtp_certification/certification_applications');?>">View All</a></div>
          </div>
        </div>
        ...
        <div class="experiance">
		  ...
		  ?>
                <li class="row">
                  ...
                  <div class="col-md-4"><a href="<?php echo base_url('nsdc_vtp_certifications/'.$row_applied_job->job_slug);?>"><?php echo $row_applied_job->job_title;?></a></div>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="<?php echo base_url('nsdc_vtp_certification/post_new_certification');?>">Post a New Job</a>&nbsp;<a href="<?php echo base_url('nsdc_vtp_certification/my_posted_certification');?>">View All</a></div>
          </div>
        </div>
            ...
            <div class="intlist">
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  ...
                  <a href="<?php echo base_url('nsdc_vtp_certification/edit_posted_nsdc_vtp_certification/'.$row_jobs->ID);?>" title="Edit" class="edit-ico"><i class="fa fa-pencil">&nbsp;</i></a>
