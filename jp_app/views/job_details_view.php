      ...
      <div class="row"> 
        ...
        <div class="col-md-4">
		 <div id="msg"></div>
          ...
          <div class="actionBox">
            <h6><?php echo ($is_already_applied=='yes')?'You have already applied for this job':'To Apply for this job click below';?></h6>
            <p></p>
        ...
        <div class="col-md-8"> 
          ...
          <div class="boxwraper">
            <div class="titlebar">
              <div class="row">
                <div class="col-sm-6"><h4>Job Detail</h4></div>
                <?php if($len){?>
                ...
                <div class="col-md-12">
                  ...
                  <div class="skillBox">
                    <ul class="skillDetail">
                      ...
                      <a href="<?php echo base_url();?>search-jobs/<?php echo make_slug($skill);?>" target="_blank"><?php echo $skill;?></a></li>
