       ...
       <!-- <div class="col-md-12">
          <div class="userinfoWrp">
            ...
            <div class="col-md-2 uploadPhoto">
            	<img src="<?php echo base_url('public/uploads/industry_yple_training/'.$image_name);?>"  />
                <div class="stripBox">
            <form name="frm_emp_up" id="frm_emp_up" method="post" action="<?php echo base_url('industry_yple_training/edit_industry_yple_training/upload_logo');?>" enctype="multipart/form-data"><input type="file" name="upload_logo" id="upload_logo" accept="image/*" style="display:none;"></form>
            ...
            <div class="col-md-4">
              ...
              <a href="<?php echo base_url('industry_yple_training/edit_company');?>" id="edit_company_profileee" class="editLink"><i class="fa fa-pencil">&nbsp;</i> Edit Company Profile</a> </div>
            <div class="clear"></div>
          </div>
        </div>
        <div class="clear"></div>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="<?php echo base_url('industry_yple_training/training_applications');?>">View All</a></div>
          </div>
        </div>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="<?php echo base_url('industry_yple_training/post_new_training');?>">Post a New Job</a>&nbsp;<a href="<?php echo base_url('industry_yple_training/my_posted_training');?>">View All</a></div>
          </div>
        </div>
            ...
            <div class="intlist">
              <div class="col-md-12">
                <div class="col-md-8"> <a href="<?php echo base_url('trainings/'.$row_jobs->job_slug);?>" class="jobtitle"><?php echo word_limiter(strip_tags($row_jobs->job_title),9);?></a>
                  <div class="location"><a href="<?php echo base_url('company_training/'.$row->company_slug);?>"><?php echo $row->company_name;?></a> &nbsp;-&nbsp; <?php echo $row_jobs->city;?></div>
                </div>
                <div class="col-md-4">
                  <div class="col-md-4 pull-right text-right">  
                  <a href="<?php echo base_url('industry_yple_training/edit_posted_industry_yple_training/'.$row_jobs->ID);?>" title="Edit" class="edit-ico"><i class="fa fa-pencil">&nbsp;</i></a>
...
<!-- Profile Popups -->
<?php $this->load->view('training/common/employers_popup_forms'); ?>
