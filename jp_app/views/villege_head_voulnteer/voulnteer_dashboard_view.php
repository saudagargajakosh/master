     ...
     <!--   <div class="col-md-12">
          <div class="userinfoWrp">
            ...
            <div class="col-md-2 uploadPhoto">
            	<img src="<?php echo base_url('public/uploads/villege_head_voulnteer/'.$image_name);?>"  />
                <div class="stripBox">
            <form name="frm_emp_up" id="frm_emp_up" method="post" action="<?php echo base_url('villege_head_voulnteer/edit_villege_head_voulnteer/upload_logo');?>" enctype="multipart/form-data"><input type="file" name="upload_logo" id="upload_logo" accept="image/*" style="display:none;"></form>
            ...
            <div class="col-md-4">
              ...
              <a href="<?php echo base_url('villege_head_voulnteer/edit_company');?>" id="edit_company_profileee" class="editLink"><i class="fa fa-pencil">&nbsp;</i> Edit Company Profile</a> </div>
            <div class="clear"></div>
          </div>
        </div>
        <div class="clear"></div>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="<?php echo base_url('villege_head_voulnteer/voulnteer_applications');?>">View All</a></div>
          </div>
        </div>
      ...
      <div class="innerbox2">
        <div class="titlebar">
          <div class="row">
            ...
            <div class="col-md-3 text-right"><a href="<?php echo base_url('villege_head_voulnteer/post_new_voulnteer');?>">Post a New Job</a>&nbsp;<a href="<?php echo base_url('villege_head_voulnteer/my_posted_voulnteer');?>">View All</a></div>
          </div>
        </div>
            ...
            <div class="intlist">
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  ...
                  <a href="<?php echo base_url('villege_head_voulnteer/edit_posted_villege_head_voulnteer/'.$row_jobs->ID);?>" title="Edit" class="edit-ico"><i class="fa fa-pencil">&nbsp;</i></a>
