            ...
            <div class="intlist">
              <div class="col-md-12">
                ...
                <div class="col-md-4">
                  ...
                  <a href="<?php echo base_url()?>villege_head_voulnteer/edit_posted_villege_head_voulnteer/<?php echo $row_jobs->ID;?>" title="Edit" class="edit-ico"><i class="fa fa-pencil">&nbsp;</i></a>
