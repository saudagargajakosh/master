...
class Posted_Training_Model extends CI_Model {
	...
	public function get_active_posted_training_by_company_id($company_id, $per_page, $page) {
       $Q = $this->db->query("CALL get_active_posted_training_by_company_id($company_id, $page, $per_page)");
        if ($Q->num_rows > 0) {
            $return = $Q->result();
        } else {
            $return = 0;
