...
class Posted_Certification_Model extends CI_Model {
	...
	public function get_active_posted_certification_by_company_id($company_id, $per_page, $page) {
       $Q = $this->db->query("CALL get_active_posted_certification_by_company_id($company_id, $page, $per_page)");
        if ($Q->num_rows > 0) {
            $return = $Q->result();
        } else {
            $return = 0;
...
");
	...
	public function get_searched_group_by_title($param) {
       $Q = $this->db->query('CALL ft_search_certification_group_by_title("'.$param.'")');
        if ($Q->num_rows > 0) {
            $return = $Q->result();
        } else {
            $return = 0;
	...
	public function get_searched_group_by_city($param) {
       $Q = $this->db->query('CALL ft_search_certification_group_by_city("'.$param.'")');
        if ($Q->num_rows > 0) {
            $return = $Q->result();
        } else {
            $return = 0;
	...
	public function get_searched_group_by_company($param) {
       $Q = $this->db->query('CALL ft_search_certification_group_by_company("'.$param.'")');
        if ($Q->num_rows > 0) {
            $return = $Q->result();
        } else {
            $return = 0;
	...
	// public function get_searched_group_by_salary_range($param) {
       // $Q = $this->db->query('CALL ft_search_certification_group_by_salary_range("'.$param.'")');
        // if ($Q->num_rows > 0) {
            // $return = $Q->result();
        // } else {
            // $return = 0;
