...
class Posted_Jobs_Model extends CI_Model {
	...
	public function get_opened_certification_home_page($per_page, $page) {
		$Q = $this->db->query('CALL get_opened_certification_home_page('.$page.','.$per_page.')');	
        if ($Q->num_rows > 0) {
            $return = $Q->result();
        } else {
            $return = 0;
	...
	public function get_opened_voulnteer_home_page($per_page, $page) {
		$Q = $this->db->query('CALL get_opened_voulnteer_home_page('.$page.','.$per_page.')');	
        if ($Q->num_rows > 0) {
            $return = $Q->result();
        } else {
            $return = 0;
		...
		public function get_opened_training_home_page($per_page, $page) {
		$Q = $this->db->query('CALL get_opened_training_home_page('.$page.','.$per_page.')');	
        if ($Q->num_rows > 0) {
            $return = $Q->result();
        } else {
            $return = 0;
