...
class Edit_Posted_Training extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'villege_head_training/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('villege_head_training/edit_posted_training_view',$data);
			return;
		}
		...
		redirect(base_url('villege_head_training/edit_posted_villege_head_training/'.$id),'');		
	}
