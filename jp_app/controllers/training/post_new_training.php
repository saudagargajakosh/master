...
class Post_New_Training extends CI_Controller {
	...
	public function index()
	{
		...
		$data['title'] = SITE_NAME.' : Post New Training';
		$data['msg']='';
		...
		$this->session->set_flashdata('msg', '<div class="alert alert-success"><a href="#" class="close" data-dismiss="alert">&times;</a><strong>Success!</strong> New training has been posted successfully.</div>');
