...
class Edit_Posted_Training extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'shg_training/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('shg_training/edit_posted_training_view',$data);
			return;
		}
		...
		redirect(base_url('shg_training/edit_posted_shg_training/'.$id),'');		
	}
