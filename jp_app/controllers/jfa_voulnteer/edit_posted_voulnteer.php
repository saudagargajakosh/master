...
class Edit_Posted_Voulnteer extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'jfa_voulnteer/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('jfa_voulnteer/edit_posted_voulnteer_view',$data);
			return;
		}
		...
		redirect(base_url('jfa_voulnteer/edit_posted_jfa_voulnteer/'.$id),'');		
	}
