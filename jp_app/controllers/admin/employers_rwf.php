...
class Employers_Rwf extends CI_Controller {
	public function index(){
		...
		$config = pagination_configuration(base_url("admin/employers_rwf"), $total_rows, 100, 3, 5, true);
		// print_r($config);
		...
		$this->load->view('admin/employers_rwf_view', $data);
		return;
	}
	...
	public function details($id=''){
		...
		if($id==''){
			redirect(base_url().'admin/employers_rwf','');
			exit;
		}
	...
	public function update($id=''){
		...
		redirect(base_url('admin/employers_rwf/update/'.$id));
		return;
	}
	...
	public function search(){
		...
		$config = pagination_configuration_search(base_url("admin/employers_rwf/search/?".$url_params), $total_rows, 50, 3, 5, true);
	...
	public function login($id){
			...
			redirect(base_url('rwf/dashboard'));
	}
}