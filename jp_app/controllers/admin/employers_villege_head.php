...
class Employers_Villege_Head extends CI_Controller {
	public function index(){
		...
		$config = pagination_configuration(base_url("admin/employers_villege_head"), $total_rows, 100, 3, 5, true);
		// print_r($config);
		...
		$this->load->view('admin/employers_villege_head_view', $data);
		return;
	}
	...
	public function details($id=''){
		...
		if($id==''){
			redirect(base_url().'admin/employers_villege_head','');
			exit;
		}
	...
	public function update($id=''){
		...
		redirect(base_url('admin/employers_villege_head/update/'.$id));
		return;
	}
	...
	public function search(){
		...
		$config = pagination_configuration_search(base_url("admin/employers_villege_head/search/?".$url_params), $total_rows, 50, 3, 5, true);
	...
	public function login($id){
			...
			redirect(base_url('villege_head/dashboard'));
	}
}