...
class Employers_Jfa extends CI_Controller {
	public function index(){
		...
		$config = pagination_configuration(base_url("admin/employers_jfa"), $total_rows, 100, 3, 5, true);
		// print_r($config);
		...
		$this->load->view('admin/employers_jfa_view', $data);
		return;
	}
	...
	public function details($id=''){
		...
		if($id==''){
			redirect(base_url().'admin/employers_jfa','');
			exit;
		}
	...
	public function update($id=''){
		...
		redirect(base_url('admin/employers_jfa/update/'.$id));
		return;
	}
	...
	public function search(){
		...
		$config = pagination_configuration_search(base_url("admin/employers_jfa/search/?".$url_params), $total_rows, 50, 3, 5, true);
