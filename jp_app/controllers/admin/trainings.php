...
class Trainings extends CI_Controller {
	public function index(){
		...
		$config = pagination_configuration(base_url("admin/trainings"), $total_rows, 50, 3, 5, true);
		// print_r($config);
		...
		$this->load->view('admin/training_view', $data);
		return;
	}
	...
	public function search(){
		...
		$config = pagination_configuration_search(base_url("admin/traininngs/search/?".$url_params), $total_rows, 50, 3, 5, true);
