...
class Voulnteer_Applications extends CI_Controller {
	...
	public function index()
	{
		...
		$config = pagination_configuration(base_url("nsdc_vtp_nsdc_vtp_voulnteer/voulnteer_applications"), $total_rows, 50, 3, 5, true);
		...
		$this->load->view('nsdc_vtp_voulnteer/voulnteer_applications_view',$data);
	}
