...
class Edit_Posted_Voulnteer extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'nsdc_vtp_voulnteer/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('nsdc_vtp_voulnteer/edit_posted_voulnteer_view',$data);
			return;
		}
		...
		redirect(base_url('nsdc_vtp_voulnteer/edit_posted_nsdc_vtp_voulnteer/'.$id),'');		
	}
