...
class Edit_Posted_Certification extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'villege_head_certification/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('villege_head_certification/edit_posted_certification_view',$data);
			return;
		}
		...
		redirect(base_url('villege_head_certification/edit_posted_villege_head_certification/'.$id),'');		
	}
