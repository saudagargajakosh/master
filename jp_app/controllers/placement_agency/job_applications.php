...
class Job_Applications extends CI_Controller {
	...
	public function index()
	{
		...
		$config = pagination_configuration(base_url("placement_agency/job_applications"), $total_rows, 50, 3, 5, true);
		...
		$this->load->view('placement_agency/job_applications_view',$data);
	}
