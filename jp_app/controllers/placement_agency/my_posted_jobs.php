...
class My_Posted_Jobs extends CI_Controller {
	...
	public function index()
	{
		...
		$config = pagination_configuration(base_url("placement_agency/my_posted_jobs"), $total_rows, 10, 3, 5, true);
		...
		$this->load->view('placement_agency/my_posted_jobs_view',$data);
	}
