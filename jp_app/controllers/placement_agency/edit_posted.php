...
class Edit_Posted extends CI_Controller {
	...
	if($id==''){
			redirect(base_url().'placement_agency/dashboard','');
			exit;
		}
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('placement_agency/edit_posted_job_view',$data);
			return;
		}
		...
		redirect(base_url('placement_agency/Edit_Posted/'.$id),'');	
	}
