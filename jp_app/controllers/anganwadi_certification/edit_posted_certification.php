...
class Edit_Posted_Certification extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'anganwadi_certification/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('anganwadi_certification/edit_posted_certification_view',$data);
			return;
		}
		...
		redirect(base_url('anganwadi_certification/edit_posted_anganwadi_certification/'.$id),'');		
	}
