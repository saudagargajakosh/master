...
class Edit_Posted_Voulnteer extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'anganwadi_voulnteer/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('anganwadi_voulnteer/edit_posted_voulnteer_view',$data);
			return;
		}
		...
		redirect(base_url('anganwadi_voulnteer/edit_posted_anganwadi_voulnteer/'.$id),'');		
	}
