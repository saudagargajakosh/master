...
class My_Posted_Training extends CI_Controller {
	...
	public function index()
	{
		...
		$config = pagination_configuration(base_url("jfa_training/my_posted_certification"), $total_rows, 10, 3, 5, true);
		...
		$this->load->view('jfa_training/my_posted_training_view',$data);
	}
