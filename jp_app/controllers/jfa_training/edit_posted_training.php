...
class Edit_Posted_Training extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'jfa_training/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('jfa_training/edit_posted_training_view',$data);
			return;
		}
		...
		redirect(base_url('jfa_training/edit_posted_jfa_training/'.$id),'');		
	}
