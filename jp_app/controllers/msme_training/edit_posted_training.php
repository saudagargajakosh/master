...
class Edit_Posted_Training extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'msme_training/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('msme_training/edit_posted_training_view',$data);
			return;
		}
		...
		redirect(base_url('msme_training/edit_posted_msme_training/'.$id),'');		
	}
