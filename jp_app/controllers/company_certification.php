...
class Company_Certification extends CI_Controller {
	...
	public function index()
	{
		...
		//Jobs by company
		$result_posted_jobs = $this->posted_certification_model->get_active_posted_certification_by_company_id($row_company->ID, 100, 0);
		...
		$this->load->view('company_certification_view',$data);
	}
