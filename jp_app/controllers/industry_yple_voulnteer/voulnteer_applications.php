...
class Voulnteer_Applications extends CI_Controller {
	...
	public function index()
	{
		...
		$data['title'] = SITE_NAME.': List of Received voulnteer Applications';
		...
		$config = pagination_configuration(base_url("industry_yple_industry_yple_voulnteer/voulnteer_applications"), $total_rows, 50, 3, 5, true);
		...
		$result_applied_jobs = $this->applied_voulnteer_model->get_applied_voulnteer_by_employer_id($this->session->userdata('user_id'), $config["per_page"], $page);
		$data['result_applied_jobs']= $result_applied_jobs;
		$this->load->view('industry_yple_voulnteer/voulnteer_applications_view',$data);
	}
