...
class Edit_Posted_Certification extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'jfa_certification/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('jfa_certification/edit_posted_certification_view',$data);
			return;
		}
		...
		redirect(base_url('jfa_certification/edit_posted_jfa_certification/'.$id),'');		
	}
