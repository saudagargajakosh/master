...
class Certification_Applications extends CI_Controller {
	...
	public function index()
	{
		...
		$config = pagination_configuration(base_url("jfa_certification/job_applications"), $total_rows, 50, 3, 5, true);
		...
		$this->load->view('jfa_certification/certification_applications_view',$data);
	}
