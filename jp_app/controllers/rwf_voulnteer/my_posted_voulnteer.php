...
class My_Posted_Voulnteer extends CI_Controller {
	...
	public function index()
	{
		...
		$config = pagination_configuration(base_url("rwf_voulnteer/my_posted_certification"), $total_rows, 10, 3, 5, true);
		...
		$this->load->view('rwf_voulnteer/my_posted_voulnteer_view',$data);
	}
