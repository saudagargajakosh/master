...
class Voulnteer_Applications extends CI_Controller {
	...
	public function index()
	{
		...
		$config = pagination_configuration(base_url("rwf_rwf_voulnteer/voulnteer_applications"), $total_rows, 50, 3, 5, true);
		...
		$this->load->view('rwf_voulnteer/voulnteer_applications_view',$data);
	}
