...
class Training_Applications extends CI_Controller {
	...
	public function index()
	{
		...
		$config = pagination_configuration(base_url("anganwadi_training/job_applications"), $total_rows, 50, 3, 5, true);
		...
		$this->load->view('anganwadi_training/training_applications_view',$data);
	}
