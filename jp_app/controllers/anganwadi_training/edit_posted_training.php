...
class Edit_Posted_Training extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'anganwadi_training/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('anganwadi_training/edit_posted_training_view',$data);
			return;
		}
		...
		redirect(base_url('anganwadi_training/edit_posted_anganwadi_training/'.$id),'');		
	}
