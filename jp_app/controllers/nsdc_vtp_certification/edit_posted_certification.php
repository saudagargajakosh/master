...
class Edit_Posted_Certification extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'nsdc_vtp_certification/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('nsdc_vtp_certification/edit_posted_certification_view',$data);
			return;
		}
		...
		redirect(base_url('nsdc_vtp_certification/edit_posted_nsdc_vtp_certification/'.$id),'');		
	}
