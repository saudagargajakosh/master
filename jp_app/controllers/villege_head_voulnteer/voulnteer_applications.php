...
class Voulnteer_Applications extends CI_Controller {
	...
	public function index()
	{
		...
		$config = pagination_configuration(base_url("villege_head_villege_head_voulnteer/voulnteer_applications"), $total_rows, 50, 3, 5, true);
		...
		$this->load->view('villege_head_voulnteer/voulnteer_applications_view',$data);
	}
