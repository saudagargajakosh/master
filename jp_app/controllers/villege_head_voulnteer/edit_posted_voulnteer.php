...
class Edit_Posted_Voulnteer extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'villege_head_voulnteer/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('villege_head_voulnteer/edit_posted_voulnteer_view',$data);
			return;
		}
		...
		redirect(base_url('villege_head_voulnteer/edit_posted_villege_head_voulnteer/'.$id),'');		
	}
