...
class Edit_Posted extends CI_Controller {
	...
	public function index($id='')
	{
		...
		$row = $this->posted_certification_model->posted_job_by_id_certification_id($id, $this->session->userdata('user_id'));
		...
		redirect(base_url('industry_yple_certification/Edit_Posted/'.$id),'');		
	}
