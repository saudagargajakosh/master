...
class Edit_Posted_Certification extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'industry_yple_certification/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('industry_yple_certification/edit_posted_certification_view',$data);
			return;
		}
		...
		redirect(base_url('industry_yple_certification/edit_posted_industry_yple_certification/'.$id),'');		
	}
