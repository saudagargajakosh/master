...
class Edit_Posted_Training extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'nsdc_vtp_training/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('nsdc_vtp_training/edit_posted_training_view',$data);
			return;
		}
		...
		redirect(base_url('nsdc_vtp_training/edit_posted_nsdc_vtp_training/'.$id),'');		
	}
