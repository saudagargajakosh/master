...
class Edit_Posted_Certification extends CI_Controller {
	...
	public function index($id='')
	{
		...
		if(!$row){
			redirect(base_url().'rwf_certification/dashboard','');
			exit;	
		}
		$data['row'] = $row;
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('rwf_certification/edit_posted_certification_view',$data);
			return;
		}
		...
		redirect(base_url('rwf_certification/edit_posted_certification/'.$id),'');		
	}
