...
class Company_Voulnteer extends CI_Controller {
	...
	public function index()
	{
		...
		//Jobs by company
		$result_posted_jobs = $this->posted_voulnteer_model->get_active_posted_voulnteer_by_company_id($row_company->ID, 100, 0);
		...
		$job_url = $row_company->company_slug.'-certification-in-';
		...
		$this->load->view('company_voulnteer_view',$data);
	}
