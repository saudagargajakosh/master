...
class Voulnteer_Applications extends CI_Controller {
	...
	public function index()
	{
		...
		$config = pagination_configuration(base_url("msme_certification/voulnteer_applications"), $total_rows, 50, 3, 5, true);
		...
		$this->load->view('msme_voulnteer/voulnteer_applications_view',$data);
	}
