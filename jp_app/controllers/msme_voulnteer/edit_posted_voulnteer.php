...
class Edit_Posted_Voulnteer extends CI_Controller {
	...
	{
		if($id==''){
			redirect(base_url().'voulnteer/dashboard','');
			exit;
		}	
		...
		if ($this->form_validation->run() === FALSE) {
			$this->load->view('msme_voulnteer/edit_posted_voulnteer_view',$data);
			return;
		}
		...
		redirect(base_url('msme_voulnteer/edit_posted_voulnteer/'.$id),'');		
	}
