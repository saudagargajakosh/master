...
class Matching_Certifications extends CI_Controller {
	...
	public function index()
	{
		...
		//Jobs by skills
		$result_jobs = $this->posted_certification_model->get_matching_searched_jobs($skill_qry, 50, 0);
		$data['result']= $result_jobs;
		$this->load->view('jobseeker/matching_certifications_view',$data);
	}
