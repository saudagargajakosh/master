...
class Apply_Voulnteer extends CI_Controller {
	...
	public function index()
	{
		...
		$row = $this->posted_voulnteer_model->get_active_posted_voulnteer_by_id($this->input->post('jid'));
		...
		$is_already_applied = $this->applied_voulnteer_model->get_applied_job_by_seeker_and_job_id($this->session->userdata('user_id'), $this->input->post('jid'));
		...
		$this->applied_voulnteer_model->add_applied_job($job_array);
		...
		$data_array = $this->posted_voulnteer_model->get_active_posted_voulnteer_by_id($this->input->post('jid'));
