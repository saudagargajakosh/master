...
class Training_Applications extends CI_Controller {
	...
	public function index()
	{
		...
		$data['title'] = SITE_NAME.': List of Received Training Applications';
		...
		$config = pagination_configuration(base_url("industry_yple_training/job_applications"), $total_rows, 50, 3, 5, true);
		...
		$this->load->view('industry_yple_training/training_applications_view',$data);
	}
