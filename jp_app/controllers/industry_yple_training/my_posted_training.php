...
class My_Posted_Training extends CI_Controller {
	...
	public function index()
	{
		...
		$data['title'] = SITE_NAME.': My Posted Training';
		...
		$config = pagination_configuration(base_url("industry_yple_training/my_posted_certification"), $total_rows, 10, 3, 5, true);
		...
		$this->load->view('industry_yple_training/my_posted_training_view',$data);
	}
