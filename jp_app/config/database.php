...
// $db['local']['username'] = 'yple';
// $db['local']['password'] = 'db$yple147';
// $db['local']['database'] = 'yple';

$db['local']['hostname'] = 'localhost';
$db['local']['username'] = 'root';
$db['local']['password'] = '';
$db['local']['database'] = 'finaljob';
...
$db['database2']['database'] = 'livelihood';
$db['database2']['dbdriver'] = 'mysqli';
$db['database2']['dbprefix'] = 'p_';
