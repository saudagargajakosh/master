...
*/
$autoload['libraries'] = array('database', 'session', 'Form_validation', 'MY_Form_validation', 'email', 'Pagination', 'user_agent',  'encrypt', 'upload','image_lib','custom_encryption','encrypt');
/*
| -------------------------------------------------------------------
...
*/
$autoload['helper'] = array('url', 'form', 'inflector', 'security', 'date', 'html', 'my_static_functions_helper','download', 'file', 'text', 'my_admin_search_helper', 'translate','my_captcha_helper','sendsms_helper', 'phpass_helper');
/*
| -------------------------------------------------------------------
