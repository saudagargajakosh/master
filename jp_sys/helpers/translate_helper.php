...
if ( ! function_exists('translate'))
{
	function translate($text, $d = '')
	{
		...
		$q = rawurlencode($text);
		// Google's API translator URL//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit
		...
		curl_setopt($ch, CURLOPT_REFERER, "http://yple.skill-mart.com/contact-us");
		$body = curl_exec($ch);
		curl_close($ch);
